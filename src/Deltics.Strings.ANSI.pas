...
interface
  ...
  type
    ANSIFn = class
    private
      class function AddressOfByte(aBase: Pointer; aByteIndex: Integer): PANSIChar; overload; {$ifdef INLINE_METHODS} inline; {$endif}
      class function AddressOfIndex(aBase: PANSIChar; aIndex: Integer): PANSIChar; overload; {$ifdef INLINE_METHODS} inline; {$endif}
      class function AddressOfIndex(const aString: ANSIString; aIndex: Integer): PANSIChar; overload; {$ifdef INLINE_METHODS} inline; {$endif}
      class procedure FastCopy(const aString: ANSIString; aDest: PANSIChar); overload; {$ifdef INLINE_METHODS} inline; {$endif}
      class procedure FastCopy(const aString: ANSIString; aDest: PANSIChar; aLen: Integer); overload; {$ifdef INLINE_METHODS} inline; {$endif}
      class procedure FastCopy(const aString: ANSIString; var aDest: ANSIString; aDestIndex: Integer); overload; {$ifdef INLINE_METHODS} inline; {$endif}
      class procedure FastCopy(const aString: ANSIString; var aDest: ANSIString; aDestIndex: Integer; aLen: Integer); overload; {$ifdef INLINE_METHODS} inline; {$endif}
      class procedure FastMove(var aString: ANSIString; aFromIndex, aToIndex, aCount: Integer); overload; {$ifdef INLINE_METHODS} inline; {$endif}
      class procedure FastWrite(const aString: ANSIString; var aDest: PANSIChar); overload; {$ifdef INLINE_METHODS} inline; {$endif}
      class procedure FastWrite(const aString: ANSIString; var aDest: PANSIChar; aLen: Integer); overload; {$ifdef INLINE_METHODS} inline; {$endif}
...
  class function ANSIFn.FromBuffer(aBuffer: PANSIChar;
