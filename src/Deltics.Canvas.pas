...
interface
  ...
  type
    ...
    public
      ...
      procedure FillRect(const aRect: TRect); reintroduce; overload;
      procedure FillRect(const aRect: TRect; const aColor: TColor); reintroduce; overload;
      procedure FillRect(const aRect: TRect; const aBrush: HBRUSH); reintroduce; overload;
      ...
      procedure FrameRect(const aRect: TRect); reintroduce; overload;
      procedure FrameRect(const aRect: TRect; const aBrush: HBRUSH); reintroduce; overload;
      procedure FrameRect(const aRect: TRect; const aColor: TColor); reintroduce; overload;
      procedure LineTo(const aPos: TPoint); reintroduce; overload;
      procedure LineTo(const aX, aY: Integer); reintroduce; overload;
      procedure LineTo(const aFrom, aTo: TPoint); reintroduce; overload;
      procedure LineTo(const aFromX, aFromY, aToX, aToY: Integer); reintroduce; overload;
      procedure MoveTo(const aPos: TPoint); reintroduce; overload;
      procedure MoveTo(const aX, aY: Integer); reintroduce; overload;
      procedure MoveTo(const aPos: TPoint; var aPrev: TPoint); reintroduce; overload;
      procedure MoveTo(const aX, aY: Integer; var aPrevX, aPrevY: Integer); reintroduce; overload;
      procedure TextExtent(const aString: String; var aRect: TRect; const aFlags: Integer); reintroduce;
