...
interface
  ...
  type
    TDelphiVersion = (
                      ...
                      dvDelphiXE8,
                      dvDelphi10_Seattle,
                      dvDelphi10dot1_Berlin,
                      dvDelphi10dot2_Tokyo,
                      dvDelphi10dot3_Rio
                     );
...
implementation
  ...
  begin
    result := {$ifdef DELPHI7}dvDelphi7{$endif}
              ...
              {$ifdef DELPHI10}dvDelphi10_Seattle{$endif}
              {$ifdef DELPHI10_1}dvDelphi10dot1_Berlin{$endif}
              {$ifdef DELPHI10_2}dvDelphi10dot2_Tokyo{$endif}
              {$ifdef DELPHI10_3}dvDelphi10dot3_Rio{$endif};
  end;
